<?php
    ...
    $retype=md5(md5(mysqli_real_escape_string($con,$_POST['retype'])));
    ...
    //echo $row['password'];
    if($row['password']==$old_password && $retype==$new_password){
        ...
        echo "Your password has been updated. Redirecting you back to your dashboard...";
        ?>
